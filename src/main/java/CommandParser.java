...
public class CommandParser {
    ...
    private String onWord = "sätt på";
    private String offWord = "stäng av";
    ...
    private State extractState(String command) {
        ...
        System.out.println("" + command + " contains " + onWord + " = " + command.contains(onWord));
        System.out.println("" + command + " contains " + offWord + " = " + command.contains(offWord));
        if (command.contains(onWord)) {
            return State.ON;
        } else if (command.contains(offWord)) {
            return State.OFF;
        }
        return null;
    }
